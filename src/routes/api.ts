...
export const ENDPOINTS = [
  ...
  },
  {
    method: 'GET',
    path: '/random',
    description: 'Returns a full condemnation profile for a randomly selected cheese — a different cheese on every call. Pass ?today_only=true to switch to deterministic daily seeding (same cheese for the entire UTC day). Includes score, severity tier, verdict, smell, texture offense, cultural damage, etymology, pairings, and roast.',
    parameters: [
      {
        name: 'today_only',
        location: 'query',
        type: 'boolean',
        required: false,
        description: 'When true, deterministically seeds the selection to today\'s UTC date — same cheese for every call on a given day. Omit or set false for a new random cheese each call.',
      },
    ],
    example_request: 'GET /random',
    example_response: {
      cheese: 'Parmesan',
      score: 1.88,
      severity_tier: 'revolting',
      ...
      found_at: 'shaved onto expensive pasta by servers who ask if you want "a little more"',
      recommended_alternative: 'a squeeze of lemon, toasted breadcrumbs, or the restraint to leave the dish alone',
      closing_statement: 'Parmesan is defended with the phrase "it adds flavor." Yes. The flavor of butyric acid.',
      etymology: {
        origin_word: 'Parmigiano',
        meaning: 'Of Parma — the city in Emilia-Romagna, Italy',
        story: 'Named after the city of Parma, where this aged abomination has been produced since at least the 13th century.',
        first_recorded: 'c. 1254 CE',
        does_this_help: false,
        why_not: 'Knowing that a city willingly named itself after this cheese does not rehabilitate the cheese.',
      },
      pairings: [
        { cheese: 'Gruyère', score: 1.9, verdict: 'REVOLTING', note: 'Frequently found on the same boards as Parmesan. Equally condemned.' },
      ],
      roast: 'Parmesan contains butyric acid — the same compound your body produces when it vomits...',
      today_only: false,
      note: 'All information presented is damning. There is no exculpatory section.',
    },
  },
