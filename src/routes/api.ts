...
export const ENDPOINTS = [
  ...
  },
  {
    method: 'GET',
    path: '/pair',
    description: 'List all cheeses with documented pairings. Returns cheese names and pairing counts. does_this_help is always false.',
    parameters: [],
    example_request: 'GET /pair',
    example_response: {
      documented_cheeses: [
        { cheese: 'parmesan', pairing_count: 4 },
        { cheese: 'brie', pairing_count: 4 },
      ],
      total: 10,
      does_this_help: false,
